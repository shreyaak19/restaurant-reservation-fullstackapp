...
<div class="login">
    ...
    <form id="customerForm" action="NewCustBack.php" method="post">
        <br>
        <label for="cust_name">Name:
        ...
        <input type="password" id="cust_password" name="cust_password" required>
        </label>
        <br>
        ...
        <br>
        <label for="cust_phone">Phone:
            <input type="tel" id="cust_phone" name="cust_phone"maxlength="10" min="0" max="9999999999" required>
        </label>
