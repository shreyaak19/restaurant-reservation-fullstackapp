...
<body>
   ...
   <div class="login-home-block">
      <a href="CustResView.php" class="login-button">View & Edit Reservations</a>
   </div>
         ...
         <section class="reservation" id="reservation">
            <form action="reservation.php" method="post">
               ...
               <div class="flex">
                  ...
                  <div class="box">
                     <p>Date</p>
                     <input type="date" name="date" class="input" min="<?= date('Y-m-d') ?>" required>
                  </div>
                  <div class="box">
                     <p>Time</p>
                     <input type="time" name="time" class="input" min="<?= date('H:i') ?>" required>
                  </div>
                  <div class="box">
                     <p>Comments</p>
